           ...
           <div className={styles['metadata-group']}>
            ...
            <Panel collapsible className={styles['panel']} expanded={this.state.openBasicPanel} eventKey="1">
              <div className={`form-group row`} >
                ...
                <div className={`${styles['radio-group']} ${styles['text-style']}`}>
                  <span style={{width:'50%'}}><input id='text' type='radio' name='type' style={{width:'20px'}} onChange={this.typeChange.bind(this,'text')}/>text</span>
                  <span style={{width:'50%'}}><input id='number' type='radio' name='type' style={{width:'20px'}} onChange={this.typeChange.bind(this,'number')}/>number</span>
                  <span style={{width:'50%'}}><input id='email' type='radio' name='type' style={{width:'20px'}} onChange={this.typeChange.bind(this,'email')}/>email</span>
                  <span style={{width:'50%'}}><input id='password' type='radio' name='type' style={{width:'20px'}} onChange={this.typeChange.bind(this,'password')}/>password</span>
                </div>
              </div>
               <div className={`form-group row`} >
